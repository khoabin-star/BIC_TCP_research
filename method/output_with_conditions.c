...
if (last_max_cwnd >= 250 && last_max_cwnd < 500 &&
    rtt >= 1 && rtt < 500) {
    bic_target = (723 * last_max_cwnd + 48 * rtt + -8093) / 1000;
}


else if (last_max_cwnd >= 1 && last_max_cwnd < 250 &&
    rtt >= 500 && rtt < 1000) {
    bic_target = (795 * last_max_cwnd + 17 * rtt + -9408) / 1000;
}


else if (last_max_cwnd >= 250 && last_max_cwnd < 500 &&
    rtt >= 500 && rtt < 1000) {
    bic_target = (765 * last_max_cwnd + 40 * rtt + -20423) / 1000;
}


else if (last_max_cwnd >= 500 && last_max_cwnd < 750 &&
    rtt >= 500 && rtt < 1000) {
    bic_target = (757 * last_max_cwnd + 59 * rtt + -30411) / 1000;
}


else if (last_max_cwnd >= 750 && last_max_cwnd < 1000 &&
    rtt >= 500 && rtt < 1000) {
